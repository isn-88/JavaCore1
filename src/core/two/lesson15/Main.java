 ...
 * ---
 * Задача:
 * С какой-то периодичностью (например, раз в 2 минуты) считывать все новые записи из лог-файла
 * и отправлять их диспетчерам для созвона с клиентами
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    new DemoRunner().start(
        ...
        Duration.ofSeconds(5), // call delay max
        3 // count of dispatchers
    );
  }
